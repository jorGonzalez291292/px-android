...
public class PaymentResultAmount extends FlexboxLayout {
    ...
    private String getAmountDetail(@NonNull final Model model) {
        if (hasPayerCostWithMultipleInstallments(model.payerCost)) {
            return String.format(Locale.getDefault(), "(%s)", getPrettyAmount(model.currencyId, model.payerCost.getTotalAmount()));
        }
        return null;
    }
    ...
    public static final class Model {
        ...
        public static class Builder {
            ...
            public Builder(@NonNull BigDecimal amount, @NonNull BigDecimal rawAmount, @NonNull String currencyId) {
                this.amount = amount;
            ...
            public Builder setDiscount(@Nullable Discount discount) {
