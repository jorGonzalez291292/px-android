...
public class PaymentResultRenderer extends Renderer<PaymentResultContainer> {
    ...
    public View render(@NonNull final PaymentResultContainer component, @NonNull final Context context,
        ...
        final View view = inflate(R.layout.px_payment_result_container, parent);

        final ViewGroup parentViewGroup = view.findViewById(R.id.container);

        final PaymentResultHeader header = view.findViewById(R.id.header);
        header.setModel(component.getHeaderModel());
