...
public class InstructionsContentTest {
    ...
    public void testInstructionsAccreditationTimeHasValidPropsForBoletoTicket() {
        ...
        Assert
            .assertEquals(accreditationTimeComponent.props.accreditationMessage, instruction.getAcreditationMessage());
        ...
        Assert.assertEquals(accreditationTimeComponent.props.accreditationComments,
            instruction.getAccreditationComments());
    }
